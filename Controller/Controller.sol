...
contract Controller is Inherit, Strings {
    ...
    /*modifier onlyApprovedOrOwnerOfItem(uint _itemId, address _msgsender) {
        require(_itemId != 0);
        address owner = core.itemToOwner(_itemId);
        require(_msgsender == owner || _msgsender == core.itemApprovals(_itemId) || core.isApprovedForAllItems(owner, _msgsender));
        _;
    }*/
    ...
    //@notice Updates champ in the core contract
